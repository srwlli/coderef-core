...
`resolveNodes` [ref](src/cli/mcp/shared.ts:418) maps a free-form query to graph nodes in a fixed precedence: exact `id`, exact `codeRefIdNoLine`, exact `name`, exact file path (returns ALL elements of the file, `byFile: true`), then a case-insensitive substring sweep over id/name/file.
...
- `ExportedNode` (type) [ref](src/cli/mcp/shared.ts:34)
- `ExportedEdge` (type) [ref](src/cli/mcp/shared.ts:35)
- `DEFAULT_LIMIT` (constant) [ref](src/cli/mcp/shared.ts:37)
- `MAX_LIMIT` (constant) [ref](src/cli/mcp/shared.ts:49)
- `IndexElement` (interface) [ref](src/cli/mcp/shared.ts:53)
- `IndexData` (interface) [ref](src/cli/mcp/shared.ts:66)
- `ArtifactCache` (interface) [ref](src/cli/mcp/shared.ts:80)
- `emptyCache` (function) [ref](src/cli/mcp/shared.ts:105)
- `attachStaleness` (function) [ref](src/cli/mcp/shared.ts:213)
- `BuildHintError` (class) [ref](src/cli/mcp/shared.ts:235)
- `loadGraph` (function) [ref](src/cli/mcp/shared.ts:331)
- `loadIndex` (function) [ref](src/cli/mcp/shared.ts:361)
- `loadValidationReport` (function) [ref](src/cli/mcp/shared.ts:375)
- `loadCanonical` (function) [ref](src/cli/mcp/shared.ts:387)
- `Resolution` (interface) [ref](src/cli/mcp/shared.ts:397)
- `resolveNodes` (function) [ref](src/cli/mcp/shared.ts:418)
- `nodeSummary` (function) [ref](src/cli/mcp/shared.ts:452)
- `clampLimit` (function) [ref](src/cli/mcp/shared.ts:462)
- `ambiguous` (function) [ref](src/cli/mcp/shared.ts:468)
- `notFound` (function) [ref](src/cli/mcp/shared.ts:478)
- `ToolHandlers` (interface) [ref](src/cli/mcp/shared.ts:488)
- `isTestFile` (function) [ref](src/cli/mcp/shared.ts:598)
- `isDemoFile` (function) [ref](src/cli/mcp/shared.ts:615)
- `edgeConfidenceOf` (function) [ref](src/cli/mcp/shared.ts:625)
- `computeChangedElements` (function) [ref](src/cli/mcp/shared.ts:642)
- `HandlerContext` (interface) [ref](src/cli/mcp/shared.ts:679)

## Dependencies

<!-- PROJECTED from .coderef/index.json imports[] -->
- `child_process` [ref](src/cli/mcp/shared.ts:22)
- `fs` [ref](src/cli/mcp/shared.ts:23)
- `path` [ref](src/cli/mcp/shared.ts:24)
- `../../export/graph-exporter.js` [ref](src/cli/mcp/shared.ts:25)
- `../../pipeline/output-validator.js` [ref](src/cli/mcp/shared.ts:26)
- `../../query/canonical-graph.js` [ref](src/cli/mcp/shared.ts:27)
- `../../pipeline/edge-confidence.js` [ref](src/cli/mcp/shared.ts:28)
- `../../query/staleness-check.js` [ref](src/cli/mcp/shared.ts:29)
- `../../query/changed-elements.js` [ref](src/cli/mcp/shared.ts:30)
- `../../utils/path-normalize.js` [ref](src/cli/mcp/shared.ts:31)
- `../mcp-response-format.js` [ref](src/cli/mcp/shared.ts:32)
...
- **RISK-10**: `resolveNodes` [ref](src/cli/mcp/shared.ts:418) is one of TWO name resolvers over the same graph (the other is `CanonicalGraphQuery.resolve`). Any change to what a name may resolve to must be applied to both, or the MCP surface and the query surface disagree. The doc-section exclusion is the live example: taught to one resolver only, name-keyed answers about code silently include documentation prose on whichever surface was missed. [verified]
...
7. **Check Edge Confidence Calculation**:
   - Confirm that `edgeConfidenceOf` correctly classifies the confidence tier of an edge based on its attributes [ref](src/cli/mcp/shared.ts:625).
   - Verify that `classifyEdgeConfidence` accurately assigns a tier to an edge based on predefined criteria [ref](src/cli/mcp/shared.ts:28).

8. **Verify Doc-Section Resolution Exclusion**:
   - Confirm `resolveNodes` returns ONLY the code element for a name shared with a doc section heading — never the `@Doc/...#<slug>` node [ref](src/cli/mcp/shared.ts:418).
...
9. **Validate Tool Handlers Contract**:
   - Confirm that the `ToolHandlers` interface enforces a contract for all tool handlers, ensuring they include necessary methods and properties [ref](src/cli/mcp/shared.ts:488).
