...
|------|----------|----------|-------|
| function | **369** | 171 | 540 |
| interface | **281** | 36 | 317 |
| type | **30** | 6 | 36 |
| component | **2** | 0 | 2 |
| class | **101** | 5 | 106 |
| constant | **2** | 0 | 2 |
...
*... and 319 more functions. See index.json for complete list.*
...
| <!-- coderef:uuid=bc596d08-babc-51dc-b7a0-ba8bf76257c1 --> `GraphBuilder` | `src/analyzer/graph-builder.ts` | `bc596d08...` |
...
| <!-- coderef:uuid=7c1d764a-c212-5cc9-9f5a-18af8bf28b55 --> `GraphExporter` | `src/export/graph-exporter.ts` | `7c1d764a...` |
...
| <!-- coderef:uuid=909011cb-a9a2-5819-8432-0afc9bb3bb8e --> `AnthropicProvider` | `src/integration/llm/anthropic-provider.ts` | `909011cb...` |
| <!-- coderef:uuid=bf5f2276-0d8f-563b-99a4-83d5d26ca8fc --> `LLMError` | `src/integration/llm/llm-provider.ts` | `bf5f2276...` |
| <!-- coderef:uuid=230e45e0-5976-5b5c-931f-e086edbd24ef --> `OpenAIProvider` | `src/integration/llm/openai-provider.ts` | `230e45e0...` |
...
| <!-- coderef:uuid=762e671d-9a9a-57e1-9ace-66e464be1c98 --> `ConversationManager` | `src/integration/rag/conversation-manager.ts` | `762e671d...` |
...
| <!-- coderef:uuid=23476138-98db-5d06-bb0b-8c88fd53b978 --> `IndexingOrchestrator` | `src/integration/rag/indexing-orchestrator.ts` | `23476138...` |
...
| <!-- coderef:uuid=75a56083-9474-5ff3-80a5-bc8a68714c76 --> `ConfigError` | `src/integration/rag/rag-config.ts` | `75a56083...` |
| <!-- coderef:uuid=d841959c-fc84-5bc8-ae36-57a740f8e9d4 --> `RAGConfigLoader` | `src/integration/rag/rag-config.ts` | `d841959c...` |
| <!-- coderef:uuid=8540f4e3-335c-57a2-95d6-6210604ad098 --> `SemanticSearchService` | `src/integration/rag/semantic-search.ts` | `8540f4e3...` |
| <!-- coderef:uuid=2fd09fd6-6ae2-5dc5-9600-66dd95bcfa59 --> `ChromaStore` | `src/integration/vector/chroma-store.ts` | `2fd09fd6...` |
| <!-- coderef:uuid=4091466c-d66c-5a12-8487-efbf4278e247 --> `PineconeStore` | `src/integration/vector/pinecone-store.ts` | `4091466c...` |
| <!-- coderef:uuid=1f7f748a-3e8c-59fd-ab82-d563398643eb --> `SQLiteVectorStore` | `src/integration/vector/sqlite-store.ts` | `1f7f748a...` |
| <!-- coderef:uuid=3e348ea7-9423-5772-9b50-08274652ae34 --> `VectorStoreError` | `src/integration/vector/vector-store.ts` | `3e348ea7...` |
| <!-- coderef:uuid=8174f439-314f-5a68-b5d6-c30757915aff --> `CodeRefParser` | `src/parser/parser.ts` | `8174f439...` |
| <!-- coderef:uuid=6283ef9e-3e4c-5455-af1b-31ef07a6b67e --> `ElementExtractor` | `src/pipeline/extractors/element-extractor.ts` | `6283ef9e...` |
| <!-- coderef:uuid=803df79e-17ff-5c44-9388-80e875480f55 --> `RelationshipExtractor` | `src/pipeline/extractors/relationship-extractor.ts` | `803df79e...` |
...
| <!-- coderef:uuid=52dc75b3-9375-5d37-a2df-57ae3a13a0d1 --> `DriftGenerator` | `src/pipeline/generators/drift-generator.ts` | `52dc75b3...` |
...
| <!-- coderef:uuid=e72ce6c9-1e83-594e-9f83-cc7d63c13de1 --> `IndexGenerator` | `src/pipeline/generators/index-generator.ts` | `e72ce6c9...` |
| <!-- coderef:uuid=fb4b2f8f-5f05-5f3e-b82e-43011a6bbd18 --> `PatternGenerator` | `src/pipeline/generators/pattern-generator.ts` | `fb4b2f8f...` |
| <!-- coderef:uuid=61c80b91-4578-548a-9400-f4a84b59a762 --> `RegistryGenerator` | `src/pipeline/generators/registry-generator.ts` | `61c80b91...` |
...
| <!-- coderef:uuid=8819b00b-1d7a-5a40-beb5-bbf60f99bdd3 --> `PipelineOrchestrator` | `src/pipeline/orchestrator.ts` | `8819b00b...` |
...
| <!-- coderef:uuid=1c113b47-4da7-5798-9353-c08b426680f3 --> `TreeSitterScanner` | `src/scanner/tree-sitter-scanner.ts` | `1c113b47...` |
...
## Exported Interfaces (281)

| Interface | File | UUID |
|-----------|------|------|
| <!-- coderef:uuid=69e94b04-890b-5e60-873e-19e9d1a1cf9f --> `MockEnvironment` | `__tests__/generators/helpers.ts` | `69e94b04...` |
| <!-- coderef:uuid=fa021624-ac04-5c59-bfc7-c06828d0ce25 --> `ConversionOptions` | `src/adapter/graph-to-elements.ts` | `fa021624...` |
...
*... and 251 more interfaces. See index.json for complete list.*

---

## Exported Type Aliases (30)
...
| <!-- coderef:uuid=0db765d4-4ca6-5b72-9991-b8048166475a --> `LLMProviderFactory` | `src/integration/llm/llm-provider.ts` | `0db765d4...` |
...
| <!-- coderef:uuid=cfc92a0e-2a1c-5fce-8006-98b71a2494fc --> `IndexingProgressCallback` | `src/integration/rag/indexing-orchestrator.ts` | `cfc92a0e...` |
| <!-- coderef:uuid=3d0f39fe-417f-525f-a342-47cbd5c1dfb6 --> `VectorStoreFactory` | `src/integration/vector/vector-store.ts` | `3d0f39fe...` |
| <!-- coderef:uuid=2de26097-3f2f-55db-8736-935dfcc1823b --> `LanguageExtension` | `src/pipeline/types.ts` | `2de26097...` |
...
| <!-- coderef:uuid=e226ebbc-4cc2-5cee-9251-6e26ab1bd294 --> `EnrichedElementData` | `src/scanner/tree-sitter-scanner.ts` | `e226ebbc...` |
