 ...
 * @exports CodeElement, ElementData, FrontendCall, MigrationCoverage, MigrationMapping, MigrationReport, RequestBodyMapping, ResponseMapping, RouteMetadata, RouteValidation, ScanOptions, ScanProgress, SchemaExamples, SchemaFieldMapping, SchemaMapping, TYPE_METADATA, TransformedCall, TypeMetadata, ValidationIssue, getHighPriorityTypes, getTypeMetadata, getTypePriority, getTypesByPriority, isValidTypeDesignator
