...
|------|----------|------------|------|------|
| 1 | <!-- coderef:uuid= --> `buildGraphTools` | 🔴 193 (Critical) | `src/cli/mcp/graph-tools.ts` | 0 dependents |
| 2 | <!-- coderef:uuid= --> `buildScopeBindingMap` | 🔴 140 (Critical) | `src/pipeline/scope-binding.ts` | 0 dependents |
| 3 | <!-- coderef:uuid= --> `projectMapData` | 🔴 131 (Critical) | `src/map/project-map-data.ts` | 0 dependents |
| 4 | <!-- coderef:uuid= --> `scanCurrentElements` | 🔴 103 (Critical) | `src/scanner/scanner.ts` | 0 dependents |
| 5 | <!-- coderef:uuid= --> `buildEdges` | 🔴 101 (Critical) | `src/pipeline/graph-builder.ts` | 0 dependents |
| 6 | <!-- coderef:uuid= --> `buildMapTools` | 🔴 100 (Critical) | `src/cli/mcp/map-tools.ts` | 0 dependents |
| 7 | <!-- coderef:uuid= --> `buildLookupTools` | 🔴 98 (Critical) | `src/cli/mcp/lookup-tools.ts` | 0 dependents |
| 8 | <!-- coderef:uuid= --> `PipelineContextGenerator.generateMarkdown` | 🔴 95 (Critical) | `src/pipeline/generators/context-generator.ts` | 0 dependents |
| 9 | <!-- coderef:uuid= --> `computeGraphAnalytics` | 🔴 87 (Critical) | `src/map/graph-analytics.ts` | 0 dependents |
...
| 12 | <!-- coderef:uuid= --> `classifyMethodCall` | 🔴 73 (Critical) | `src/pipeline/call-resolver.ts` | 0 dependents |
| 13 | <!-- coderef:uuid= --> `computeLayerDrift` | 🔴 67 (Critical) | `src/map/layer-drift.ts` | 0 dependents |
| 14 | <!-- coderef:uuid= --> `runPopulate` | 🔴 64 (Critical) | `src/cli/populate.ts` | 0 dependents |
| 15 | <!-- coderef:uuid= --> `ASTElementScanner.visitNode` | 🔴 62 (Critical) | `src/analyzer/ast-element-scanner.ts` | 0 dependents |
...
| <!-- coderef:uuid= --> `heritage-index.ts` | library | `src/pipeline/heritage-index.ts` |
...
- `buildGraphTools` (src/cli/mcp/graph-tools.ts) - complexity 193
- `buildScopeBindingMap` (src/pipeline/scope-binding.ts) - complexity 140
- `projectMapData` (src/map/project-map-data.ts) - complexity 131
- `scanCurrentElements` (src/scanner/scanner.ts) - complexity 103
- `buildEdges` (src/pipeline/graph-builder.ts) - complexity 101
...
- `classifyMethodCall` (src/pipeline/call-resolver.ts) - complexity 73
