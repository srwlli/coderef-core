...
Real-world self-scan baseline (post WO-EDGE-RESOLUTION-IMPROVEMENT-PROGRAM-001 P2, 2026-08-01): `valid_edge_count=10005`, `resolved_of_resolvable=74.62%` (the honest resolver-quality read; raw all-calls `resolution_rate=22.47%` includes builtin/external by design), `unresolved_count=1673` (was 18,527 pre-program — test-DSL and external-receiver calls now carry honest dispositions), headers ~98% coverage, dependency cycles **0**.
