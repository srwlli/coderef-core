...
|------|----------|----------|-------|
| function | **444** | 721 | 1165 |
| constant | **72** | 263 | 335 |
| interface | **524** | 100 | 624 |
| type | **71** | 25 | 96 |
| class | **104** | 4 | 108 |

---

## Exported Functions (444)
...
*... and 394 more functions. See index.json for complete list.*
...
| <!-- coderef:uuid=75eefd63-594b-5055-a922-e2373d25e154 --> `GraphExporter` | `src/export/graph-exporter.ts` | `75eefd63...` |
...
| <!-- coderef:uuid=31c9a66a-29df-5b7b-b590-02b2c0464670 --> `MapProjectionError` | `src/map/project-map-data.ts` | `31c9a66a...` |
...
*... and 494 more interfaces. See index.json for complete list.*

---

## Exported Type Aliases (71)
...
| <!-- coderef:uuid=b6c1bcbb-ff8b-5051-b07a-57cf10df0350 --> `ContextTools` | `src/cli/mcp/context-tools.ts` | `b6c1bcbb...` |
| <!-- coderef:uuid=5c430e8f-da65-501b-a205-656251a269c7 --> `GraphTools` | `src/cli/mcp/graph-tools.ts` | `5c430e8f...` |
...
| <!-- coderef:uuid=512e5624-24fc-5d2b-a9a3-3227da251f46 --> `ExportedGraphEdgeResolutionStatus` | `src/export/graph-exporter.ts` | `512e5624...` |
...
| <!-- coderef:uuid=95b71fcd-b6a1-5491-8859-c65d45e0c87e --> `CallResolutionKind` | `src/pipeline/call-resolver.ts` | `95b71fcd...` |
| <!-- coderef:uuid=b8290320-3fd9-553b-b70d-7676762f9f53 --> `SymbolTable` | `src/pipeline/call-resolver.ts` | `b8290320...` |
...
| <!-- coderef:uuid=02c7c0ed-75bb-59ad-840d-818f051532ff --> `EdgeRelationship` | `src/pipeline/graph-builder.ts` | `02c7c0ed...` |
| <!-- coderef:uuid=ba32a938-1316-57e9-b6f6-fc2b9bef4f61 --> `EdgeResolutionStatus` | `src/pipeline/graph-builder.ts` | `ba32a938...` |
| <!-- coderef:uuid=6b1c5af4-1880-5c25-8f19-0ae0092c241f --> `EdgeEvidence` | `src/pipeline/graph-builder.ts` | `6b1c5af4...` |
| <!-- coderef:uuid=04a60082-9efe-5a71-a032-7c2877534c04 --> `HeritageIndex` | `src/pipeline/heritage-index.ts` | `04a60082...` |
| <!-- coderef:uuid=cbf1b307-7e44-529f-ac46-6e7984252d0f --> `ImportResolutionKind` | `src/pipeline/import-resolver.ts` | `cbf1b307...` |
| <!-- coderef:uuid=fcac8aaa-13cb-5e68-802d-afa5bbbd5f10 --> `ExportTable` | `src/pipeline/import-resolver.ts` | `fcac8aaa...` |
| <!-- coderef:uuid=04e90840-4ca2-5431-94cb-ecf870af729f --> `LegacyGraphBuilder` | `src/pipeline/phases/resolve-tail.ts` | `04e90840...` |
| <!-- coderef:uuid=e0c442c3-5ae5-5f00-a783-d4379f01b947 --> `ScopeBindingKind` | `src/pipeline/scope-binding.ts` | `e0c442c3...` |
| <!-- coderef:uuid=8cdb1a89-8508-55b1-bb42-2771bf17b705 --> `ScopeBindingMap` | `src/pipeline/scope-binding.ts` | `8cdb1a89...` |
| <!-- coderef:uuid=dcca5723-e5ef-57ea-a8f3-aa4f61b845a5 --> `LanguageExtension` | `src/pipeline/types.ts` | `dcca5723...` |
| <!-- coderef:uuid=84e370ab-a539-56a3-834c-a31f2c50bfb3 --> `RawExportKind` | `src/pipeline/types.ts` | `84e370ab...` |
| <!-- coderef:uuid=facb188a-984a-5213-acd6-a65e62d57a5f --> `WorkspaceRegistry` | `src/pipeline/workspace-registry.ts` | `facb188a...` |
