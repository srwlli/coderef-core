 ...
 * @used_by src/fileGeneration/detectDrift.ts, src/fileGeneration/saveIndex.ts, src/fileGeneration/index-storage.ts, src/pipeline/generators/drift-generator.ts, src/pipeline/generators/index-generator.ts
 */
