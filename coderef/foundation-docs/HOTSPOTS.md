...
| 3 | <!-- coderef:uuid= --> `buildScopeBindingMap` | 🔴 109 (Critical) | `src/pipeline/scope-binding.ts` | 0 dependents |
...
| 9 | <!-- coderef:uuid= --> `buildEdges` | 🔴 83 (Critical) | `src/pipeline/graph-builder.ts` | 0 dependents |
| 10 | <!-- coderef:uuid= --> `buildVerifyTools` | 🔴 78 (Critical) | `src/cli/mcp/verify-tools.ts` | 0 dependents |
| 11 | <!-- coderef:uuid= --> `classifyMethodCall` | 🔴 76 (Critical) | `src/pipeline/call-resolver.ts` | 0 dependents |
| 12 | <!-- coderef:uuid= --> `runRagIndex` | 🔴 73 (Critical) | `src/cli/rag-index.ts` | 0 dependents |
...
- `buildScopeBindingMap` (src/pipeline/scope-binding.ts) - complexity 109
...
- `buildEdges` (src/pipeline/graph-builder.ts) - complexity 83
- `buildVerifyTools` (src/cli/mcp/verify-tools.ts) - complexity 78
- `classifyMethodCall` (src/pipeline/call-resolver.ts) - complexity 76
