...
|------|----------|----------|-------|
| function | **368** | 140 | 508 |
| interface | **278** | 35 | 313 |
| type | **30** | 6 | 36 |
| component | **2** | 0 | 2 |
| class | **101** | 4 | 105 |
| constant | **2** | 0 | 2 |
...
| <!-- coderef:uuid=fb1dda84-2f16-505f-bca0-78a81e03e0e8 --> `detect_duplicate_pairs` | `autoresearch/scanner-quality/scripts/verify_element_classification.py` | ❌ |  | `fb1dda84...` |
| <!-- coderef:uuid=3944fa5f-748e-51bc-8201-f8830dd45684 --> `calculate_score` | `autoresearch/scanner-quality/scripts/verify_element_classification.py` | ❌ |  | `3944fa5f...` |

*... and 318 more functions. See index.json for complete list.*
...
| <!-- coderef:uuid=f04a16bd-cd2b-59fd-8b26-7eef3118b5ff --> `MiddlewareDetector` | `src/analyzer/middleware-detector.ts` | `f04a16bd...` |
...
| <!-- coderef:uuid=3ca02dda-0a2c-5c73-a47a-b52b6229b513 --> `AnthropicProvider` | `src/integration/llm/anthropic-provider.ts` | `3ca02dda...` |
| <!-- coderef:uuid=29aa5b2f-4963-5ef8-bc98-a365633f59c6 --> `LLMError` | `src/integration/llm/llm-provider.ts` | `29aa5b2f...` |
| <!-- coderef:uuid=6d103658-581a-5399-b814-4de65c3b6949 --> `OpenAIProvider` | `src/integration/llm/openai-provider.ts` | `6d103658...` |
...
| <!-- coderef:uuid=144933ae-dcfd-5985-9fae-744fb5923d25 --> `ConversationManager` | `src/integration/rag/conversation-manager.ts` | `144933ae...` |
...
| <!-- coderef:uuid=4ec161c7-c571-5e59-b1f0-c3ac8ba8166b --> `ConfigError` | `src/integration/rag/rag-config.ts` | `4ec161c7...` |
| <!-- coderef:uuid=a442e53c-15ef-5287-a116-b333c2afc8aa --> `RAGConfigLoader` | `src/integration/rag/rag-config.ts` | `a442e53c...` |
| <!-- coderef:uuid=3b23f556-063e-57e2-8689-f4fbbd599cc3 --> `SemanticSearchService` | `src/integration/rag/semantic-search.ts` | `3b23f556...` |
| <!-- coderef:uuid=f2f013d5-f5be-53b3-bc56-f34aa6e1ad4a --> `ChromaStore` | `src/integration/vector/chroma-store.ts` | `f2f013d5...` |
| <!-- coderef:uuid=a0bd645e-a368-53a0-90b8-437bd460f4af --> `PineconeStore` | `src/integration/vector/pinecone-store.ts` | `a0bd645e...` |
...
| <!-- coderef:uuid=6f02454d-894b-5b59-8836-e4ab938d96bf --> `DriftGenerator` | `src/pipeline/generators/drift-generator.ts` | `6f02454d...` |
...
*... and 248 more interfaces. See index.json for complete list.*
...
| <!-- coderef:uuid=34943be9-31be-5aa2-89cb-839d73384134 --> `LLMProviderFactory` | `src/integration/llm/llm-provider.ts` | `34943be9...` |
...
| <!-- coderef:uuid=c4c928fa-6c20-5d1f-b942-72713975c66a --> `VectorStoreFactory` | `src/integration/vector/vector-store.ts` | `c4c928fa...` |
