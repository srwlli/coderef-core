...
|------|----------|----------|-------|
| function | **447** | 734 | 1181 |
| constant | **72** | 267 | 339 |
| interface | **525** | 100 | 625 |
| type | **71** | 25 | 96 |
| class | **104** | 4 | 108 |

---

## Exported Functions (447)
...
*... and 397 more functions. See index.json for complete list.*
...
| <!-- coderef:uuid=148f79ed-acde-5975-91c2-077dd95604ed --> `GraphExporter` | `src/export/graph-exporter.ts` | `148f79ed...` |
...
*... and 495 more interfaces. See index.json for complete list.*
...
| <!-- coderef:uuid=16189794-230e-5bbe-920f-07975c7feec7 --> `GraphTools` | `src/cli/mcp/graph-tools.ts` | `16189794...` |
...
| <!-- coderef:uuid=1b82cdf0-14f6-579f-81e7-3b68f15ca8a9 --> `ExportedGraphEdgeResolutionStatus` | `src/export/graph-exporter.ts` | `1b82cdf0...` |
...
| <!-- coderef:uuid=4fa8d38b-0c24-5b47-978b-bf2263899107 --> `EdgeResolutionStatus` | `src/pipeline/graph-builder.ts` | `4fa8d38b...` |
| <!-- coderef:uuid=b7cf2f4b-3c27-523a-a22f-c8c9b2caab0f --> `EdgeEvidence` | `src/pipeline/graph-builder.ts` | `b7cf2f4b...` |
| <!-- coderef:uuid=1805920a-8b53-5cc4-8603-4f4a6352d001 --> `HeritageIndex` | `src/pipeline/heritage-index.ts` | `1805920a...` |
| <!-- coderef:uuid=6482049f-7be0-5db1-88c2-8aa44b064031 --> `ImportResolutionKind` | `src/pipeline/import-resolver.ts` | `6482049f...` |
| <!-- coderef:uuid=b044b0bf-8ffa-5db9-be80-92bc36c6512a --> `ExportTable` | `src/pipeline/import-resolver.ts` | `b044b0bf...` |
| <!-- coderef:uuid=91e9a7fb-2a33-5873-b7f0-d2ffca00181d --> `LegacyGraphBuilder` | `src/pipeline/phases/resolve-tail.ts` | `91e9a7fb...` |
| <!-- coderef:uuid=e6aaa9fb-c680-5faf-8556-63b91c0cca85 --> `ScopeBindingKind` | `src/pipeline/scope-binding.ts` | `e6aaa9fb...` |
| <!-- coderef:uuid=8f5965e8-c29f-551e-9d47-f0c4a75698ed --> `ScopeBindingMap` | `src/pipeline/scope-binding.ts` | `8f5965e8...` |
...
| <!-- coderef:uuid=bfefa723-7cd0-59bd-8c27-e85631f504e2 --> `WorkspaceRegistry` | `src/pipeline/workspace-registry.ts` | `bfefa723...` |
